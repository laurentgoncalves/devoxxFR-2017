...
|===
|Date				|Salle				|Type				|Description
|11:15 / 12:00		|Neuilly 252 AB		|Conference			|Architecture par la pratique: patterns d'utilisation de systèmes in-memory - WD-40 entre vos données et vos applis
|12:05 / 12:20		|Neuilly 252 AB		|Quickie			|HTTP 2 du point de vue du développeur
